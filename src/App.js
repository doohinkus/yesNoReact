...
export default function App() {
  ...
  return (
    <div className='App' style={styles}>
      <h1>Yes No Oracle</h1>
      <iframe src="//rcm-na.amazon-adsystem.com/e/cm?o=1&p=13&l=ez&f=ifr&linkID=915d7b94c70ae08558f4c46a9342f35c&t=rafaeliscodin-20&tracking_id=rafaeliscodin-20" width="468" height="60" scrolling="no" border="0" marginwidth="0" style={{border:'none'}} frameborder="0"></iframe>
      ...
      <div className='footer'>
        <a href={link} target='_blank'>
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" class="twtr-icon">
        ...
        <a href={`https://www.facebook.com/sharer/sharer.php?u=${url}`}>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 266.893 266.895" class="fcbk-icon">
